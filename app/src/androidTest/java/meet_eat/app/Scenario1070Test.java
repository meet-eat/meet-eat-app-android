...
public class Scenario1070Test {
    ...
    public void testScenario1070() {
        ...
        // Open offer report view
        onView(withId(R.id.ibtOfferDetailedReport)).perform(click());

        // [TA 2100]: Fill in report message and send report request
        onView(withId(R.id.etOfferReportMessage)).perform(typeText(reportMessage));
        closeSoftKeyboard();
        onView(withId(R.id.btOfferReport)).perform(click());
    }
}
